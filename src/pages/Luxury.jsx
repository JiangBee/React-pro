...
class Com extends Component {
  ...
  downFn () {
    ...
    if (number === 1) {
      number = -1
      api.requestLuxurysortdown(number).then(data => {
          // console.log(data)
          this.setState({
            list: data,
            sortnum: number
...
//默认排序
  Fn = (e) => {
    api.requestLuxuryList().then(data => {
      this.setState({
        list: data
      })
    });
  ...
  componentDidMount () {
    api.requestLuxuryBanner().then(data => {
      this.setState({
        bannerdata: data
      })
    });
      ...
      <div className = "content">
        <Carousel
          ...
          <div className="listBox">
            <div className="sort">
              <ul>
                <li onClick={ (e) => {this.Fn(e)} }>默认<i className="iconfont icon-xiasanjiao"></i></li>
                <li>新品</li>
                <li>人气</li>
